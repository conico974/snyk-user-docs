...
<figure><img src="../../.gitbook/assets/account-settings-general-auth-token (1) (1).png" alt="API token screen; revoke; regenerate; click to show"><figcaption><p>API token screen; revoke; regenerate; click to show</p></figcaption></figure>
